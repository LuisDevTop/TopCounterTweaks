...
$mobiletweaks = @(
	...
	"Install7Zip",
	"InstallChocoUpdates",
	"EnableUlimatePower",    # TopCounter don't change order it will break other functions! just disable if you want with #
	### TopCounter Windows Defender Settings! Don't Change Order Just Disable with # If You Don't want it ###
	"MSIMode",                       #Enable Or Disable MSI Mode For Supported Cards, WARNING ENABLING MSI MODE MIGHT CRUSH YOUR SYSTEM! IF IT HAPPENS PLEASE RESTORE LAST WORKING SYSTEM RESTORE POINT AND DON'T ENABLE MSI MODE ON THIS SYSTEM AGAIN!
	"askDefender",
	"DorEOneDrive",                  #Option to Install Or Uninstall Microsoft One Drive!
	"askXBOX",
	...
	### Unpinning ###
	"UnpinStartMenuTiles",
        ### TopCounter Quality Of Life Tweaks ###
	"QOL",
        ### TopCounter Gaming Tweaks ###
	"FullscreenOptimizationFIX",
	"GameOptimizationFIX",
	"ApplyPCOptimizations",
	"RawMouseInput",
...
Function QOL {
       	Write-Output "Enabling TopCounter Quality of Life Tweaks..."
	$errpref = $ErrorActionPreference #save actual preference
        $ErrorActionPreference = "silentlycontinue"
...
#TopCounter Ultimate CLeaner
Function UltimateCleaner {
    Write-Host "Running TopCounter Ultimate Cleaner => Temp folders & Flush DNS + Reset IP...."
...
Function CreateRestorePoint {
  ...
  Checkpoint-Computer -Description "TopCounterRecoveryScript" -RestorePointType "MODIFY_SETTINGS"
}
